...
function getnumber()
{
    $url = "https://smshub.org/stubs/handler_api.php?api_key=101211Uf86f73fdb515662f610acd4b84bf40ae&action=getNumber&service=ot&operator=&country=6";
    $headers = array();
...
{
    $url = "https://smshub.org/stubs/handler_api.php?api_key=101211Uf86f73fdb515662f610acd4b84bf40ae&action=getStatus&id=$id";
    $headers = array();
    $getotp = request1($url, $headers);
...
{
    $url = "https://smshub.org/stubs/handler_api.php?api_key=101211Uf86f73fdb515662f610acd4b84bf40ae&action=setStatus&status=3&id=$id";
    $headers = array();
    $getotp = request1($url, $headers);
...
{
    $url = "https://smshub.org/stubs/handler_api.php?api_key=101211Uf86f73fdb515662f610acd4b84bf40ae&action=setStatus&status=6&id=$id";
    $headers = array();
    $getotp = request1($url, $headers);
    $subif = substr($getotp, 0, 16);
    if ($subif == "ACCESS_RETRY_GET") {
...
{
    $url = "https://smshub.org/stubs/handler_api.php?api_key=101211Uf86f73fdb515662f610acd4b84bf40ae&action=setStatus&status=8&id=$id";
    $headers = array();
    $getotp = request1($url, $headers);
    $subif = substr($getotp, 0, 16);
    if ($subif == "ACCESS_RETRY_GET") {
